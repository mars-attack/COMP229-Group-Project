...
UpdateUserComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: UpdateUserComponent, selectors: [["app-update-user"]], decls: 38, vars: 32, consts: [[1, "container", "mb-5"], [1, "row"], [1, "col-md-6", "offset-md-3", "col-lg-6", "offset-lg-3", "col-sm-8", "offset-sm-1"], ["autocomplete", "off"], [1, "text-center"], [1, "form-group"], ["for", "email", 3, "ngStyle"], ["type", " email", "name", "email", "placeholder", "Enter Email", "id", "email", "autocomplete", "off", "required", "", "emailValidateDirective", "", 1, "form-control", 3, "ngModel", "ngClass", "ngModelChange"], ["email", "ngModel"], ["class", "invalid-feedback", 4, "ngIf"], ["for", "displayName", 3, "ngStyle"], ["type", "displayName", "name", "displayName", "placeholder", "Enter Display Name", "required", "", 1, "form-control", 3, "ngModel", "ngClass", "ngModelChange"], ["displayName", "ngModel"], ["for", "password", 3, "ngStyle"], ["type", "password", "name", "password", "placeholder", "Enter Current Password", "id", "password", "required", "", "autocomplete", "off", 1, "form-control", 3, "ngModel", "ngClass", "ngModelChange"], ["password", "ngModel"], ["for", "newPassword", 3, "ngStyle"], ["type", "password", "name", "newPassword", "placeholder", "Enter New Password", "minlength", "6", 1, "form-control", 3, "ngModel", "ngClass", "ngModelChange"], ["newPassword", "ngModel"], [1, "mt-4", "form-group", "text-left"], ["type", "submit", 1, "btn", "btn-primary", "m-1", 3, "click"], [1, "fas", "fa-sign-in-alt"], ["routerLink", "/home", 1, "btn", "btn-secondary", "m-1"], [1, "fas", "fa-undo"], [1, "invalid-feedback"], [4, "ngIf"]], template: function UpdateUserComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "main", 0);
